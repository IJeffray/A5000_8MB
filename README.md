...
The 1.0 design has been built and tested up to 50MHz (16.66MHz RAM) - there was one design fault with DBE not tracked to the MEMC connector, requiring a tricky cut and strap fix - this was corrected in the 1.1 design which was never actually built.  The 1.1 design also adds a manual moveable link for clock selection internal / external so that the onboard overclock oscillator may be left populated and only activated when desired.  A further update as version 1.2 replaces the original FFC connector with the pair of 26 way IDCs (one 31.5mm long and another 53.5mm) for easier soldering and cabling.  A position for a DIP oscillator/socket was also added to accommodate easier tweaking of the clock speed and more SMT components were moved to the bottom side with the plan that a single-side load SMT assembly of jellybean parts may be undertaken.  The 1.2 design has been been built and tested up to 16.66MHz.
